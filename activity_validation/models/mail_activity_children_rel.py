...
class MailActivityChildrenRel(models.TransientModel):
    ...
    activity_user_id = fields.Many2one(
        related="mail_children_activity_id.activity_user_id"
    )
    mail_children_activity_id = fields.Many2one(
        "mail.activity.schedule", "Child Activity"
    )
    mail_parent_activity_id = fields.Many2one(
        "mail.activity.schedule", "Parent Activity"
    )
    plm_state = fields.Selection(related="mail_children_activity_id.plm_state")
