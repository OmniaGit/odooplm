...
class StockMove(models.Model):
    ...
    def _should_bypass_set_qty_producing(self):
        ...
        if production and (
            (self.product_id in production.workorder_ids.quality_point_ids.component_id)
    ...
    def _is_manual_consumption(self):
        ...
        is_linked_to_quality_check = any(
            qc.test_type == "register_consumed_materials"
            for qc in self.move_line_ids.quality_check_ids
        )
