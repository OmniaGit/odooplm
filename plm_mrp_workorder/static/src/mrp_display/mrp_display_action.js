...
import { MrpDisplay } from "@plm_mrp_workorder/mrp_display/mrp_display";
import { Component, onWillStart } from "@odoo/owl";
import { MrpDisplaySearchModel } from "@plm_mrp_workorder/mrp_display/search_model";

// from record.js
const defaultActiveField = { attrs: {}, options: {}, domain: "[]", string: "" };

export class MrpDisplayAction extends Component {
    static template = "plm_mrp_workorder.MrpDisplayAction";
