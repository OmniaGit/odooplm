...
import { ControlPanelButtons } from "@plm_mrp_workorder/mrp_display/control_panel";
...
import { MrpDisplayEmployeesPanel } from "@plm_mrp_workorder/mrp_display/employees_panel";
import { PinPopup } from "@plm_mrp_workorder/components/pin_popup";
import { useConnectedEmployee } from "@plm_mrp_workorder/mrp_display/hooks/employee_hooks";
import { MrpDisplaySearchBar } from "@plm_mrp_workorder/mrp_display/search_bar";
...
export class MrpDisplay extends Component {
    static template = "plm_mrp_workorder.MrpDisplay";
    static components = {
        Layout,
        ControlPanelButtons,
        MrpDisplayRecord,
...
//        this.homeMenu = useService("home_menu");
        ...
        useSubEnv({
            localStorageName: `plm_mrp_workorder.db_${session.db}.user_${user.userId}.picking_type_${this.pickingTypeId}`,
        });
        ...
        this.state = useState({
            ...
            activeWorkcenter,
            workcenters,
            showEmployeesPanel: localStorage.getItem("plm_mrp_workorder.show_employees") === "true",
        ...
        onWillStart(async () => {
            this.groups = {
                ...
                timer: await user.hasGroup("plm_mrp_workorder.group_mrp_wo_tablet_timer")
            };
    ...
    close() {
        let url = location.href.split('/shop-floor');
...
//        this.homeMenu.toggle();
    ...
    toggleEmployeesPanel() {
        ...
        localStorage.setItem("plm_mrp_workorder.show_employees", String(this.state.showEmployeesPanel));
    }
