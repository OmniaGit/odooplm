...
export class GanttRenderer extends Component {
    ...
    static template = "plm_web_gantt.GanttRenderer";
    static connectorCreatorTemplate = "plm_web_gantt.GanttRenderer.ConnectorCreator";
    static headerTemplate = "plm_web_gantt.GanttRenderer.Header";
    static pillTemplate = "plm_web_gantt.GanttRenderer.Pill";
    static groupPillTemplate = "plm_web_gantt.GanttRenderer.GroupPill";
    static rowContentTemplate = "plm_web_gantt.GanttRenderer.RowContent";
    static rowHeaderTemplate = "plm_web_gantt.GanttRenderer.RowHeader";
    static totalRowTemplate = "plm_web_gantt.GanttRenderer.TotalRow";
