...
export class GanttRendererControls extends Component {
    static template = "plm_web_gantt.GanttRendererControls";
    static components = {
        Dropdown,
        DropdownItem,
    };
    static props = ["model", "displayExpandCollapseButtons", "focusToday", "getCurrentFocusDate"];
    static toolbarContentTemplate = "plm_web_gantt.GanttRendererControls.ToolbarContent";
    static rangeMenuTemplate = "plm_web_gantt.GanttRendererControls.RangeMenu";
