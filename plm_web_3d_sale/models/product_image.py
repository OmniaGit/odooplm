...
def getWebGlBase64():
    file_path = get_module_resource("plm_web_3d_sale", "static/src/img", "webgl3d.png")
...
class ProductImage(models.Model):
    ...
    ir_attachment_webgl_id = fields.Many2one(
        "ir.attachment",
        string="Documenti Collegati",
        domain=[("has_web3d", "=", True), ("public", "=", True)],
    )
    ...
    def _compute_embed_code(self):
        ...
        for image in self:
            ...
            if url:
                image.embed_code = (
                    '<iframe id="embedded_odoo_plm_webgl" src="%s"></iframe>' % url
