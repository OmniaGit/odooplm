...
class PlmConfigSettings(models.TransientModel):
    ...
    module_plm_automate_normal_bom = fields.Boolean("Allow to create normal BOM if not exists and product are released.")
    ...
    module_plm_product_description_language_helper = fields.Boolean("Product Description Language Helper")
    module_plm_report_language_helper = fields.Boolean("Manage more Language PLM reports")
