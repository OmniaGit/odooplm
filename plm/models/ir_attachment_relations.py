...
class PlmDocumentRelations(models.Model):
    ...
    parent_revision = fields.Integer(
        related="parent_id.engineering_revision", string="Parent Revision", store=False
    )
    ...
    child_id = fields.Many2one(
        "ir.attachment", "Related child document", ondelete="cascade", index=True
    )
    ...
    userid = fields.Many2one("res.users", "CheckOut User", default=False, readonly=True)
