    ...
    def getAttachedHtmlDoucment(self, product_ids):
        ...
        for product_id in self.env['product.product'].browse(product_ids):
            for ir_attachment in product_id.linkeddocuments:
                html_rendered = view_obj._render_template('plm.document_search_button', {'doc': ir_attachment})
                html_tooltip = view_obj._render_template('plm.document_search_tooltip', {'doc': ir_attachment})
