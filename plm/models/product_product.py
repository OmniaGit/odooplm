...
class ProductProduct(models.Model):
    ...
    def _action_ondocuments(
        self, action_name, include_statuses=None, check_in_check=True, **kwargs
    ):
        """
    ...
    def name_get(self):
        ...
        for res in ret:
            ...
            if prod.default_code:
                ...
                eng_code = (
                    f"[{prod.engineering_code}_{prod.engineering_revision}] {eng_code}"
                )
    ...
    def _name_search(self, name, domain=None, operator="ilike", limit=None, order=None):
        ...
        product_ids = list(
            super()._name_search(name, domain, operator, limit, order=None)
        )
...
class ProductProductDashboard(models.Model):
    ...
    count_component_released = fields.Integer("Released", readonly=True, translate=True)
