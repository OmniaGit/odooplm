...
class ProductProductExtended(models.TransientModel):
    ...
    reviseDocument = fields.Boolean('Document Revision', help="""Make new revision of the linked document ?""")
    reviseEbom = fields.Boolean('Engineering Bom Revision', help="""Make new revision of the linked Engineering BOM ?""")
    reviseNbom = fields.Boolean('Normal Bom Revision', help="""Make new revision of the linked Normal BOM ?""")
    reviseSbom = fields.Boolean('Spare Bom Revision', help="""Make new revision of the linked Spare BOM ?""")
